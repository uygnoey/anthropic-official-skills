---
name: parallel-desktop-workflows
description: A reusable checklist for using Claude Code desktop features to manage parallel work across multiple sessions, panes, and projects.
---
